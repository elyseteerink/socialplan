...
--
-- Host: localhost
-- Generation Time: Apr 23, 2014 at 08:46 PM
...
(1, 'Default Site', 'default', 'localhost', 1, 1397319168, 0);
...
(1, 'elyseteerink@gmail.com', 'aa60dadcb759a8719602f94cd4ddb13512a561ad', '8f8ad', 1, '', 1, '', 1397319168, 1397319168, 'admin', NULL, NULL);
...
('e98056a6933b6f260c22c8b4b04c095d', '::1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/34.0.1847.116 Safari/537.36', 1397328614, 'a:6:{s:8:"username";s:5:"admin";s:5:"email";s:22:"elyseteerink@gmail.com";s:2:"id";s:1:"1";s:7:"user_id";s:1:"1";s:8:"group_id";s:1:"1";s:5:"group";s:5:"admin";}'),
('8d59a69bad5cab620d9bb39a0d5dfcd1', '::1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/34.0.1847.116 Safari/537.36', 1398180592, ''),
('9d581738e9c2f37475a2abd53630af93', '::1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/34.0.1847.116 Safari/537.36', 1398271050, 'a:7:{s:14:"admin_redirect";s:36:"admin/navigation/ajax_link_details/5";s:8:"username";s:5:"admin";s:5:"email";s:22:"elyseteerink@gmail.com";s:2:"id";s:1:"1";s:7:"user_id";s:1:"1";s:8:"group_id";s:1:"1";s:5:"group";s:5:"admin";}');
...
(1, '2014-04-12 18:12:49', NULL, 1, NULL, '<p>Welcome to our homepage. We have not quite finished setting up our website yet, but please add us to your bookmarks and come back soon.</p>'),
(2, '2014-04-12 18:12:49', NULL, 1, NULL, '<p>To contact us please fill out the form below.</p>\n				{{ contact:form name="text|required" email="text|required|valid_email" subject="dropdown|Support|Sales|Feedback|Other" message="textarea" attachment="file|zip" }}\n					<div><label for="name">Name:</label>{{ name }}</div>\n					<div><label for="email">Email:</label>{{ email }}</div>\n					<div><label for="subject">Subject:</label>{{ subject }}</div>\n					<div><label for="message">Message:</label>{{ message }}</div>\n					<div><label for="attachment">Attach  a zip file:</label>{{ attachment }}</div>\n				{{ /contact:form }}'),
(3, '2014-04-12 18:12:49', NULL, 1, NULL, '{{ search:form class="search-form" }} \n		<input name="q" placeholder="Search terms..." />\n	{{ /search:form }}'),
(4, '2014-04-12 18:12:49', NULL, 1, NULL, '{{ search:form class="search-form" }} \n		<input name="q" placeholder="Search terms..." />\n	{{ /search:form }}\n\n{{ search:results }}\n\n	{{ total }} results for "{{ query }}".\n\n	<hr />\n\n	{{ entries }}\n\n		<article>\n			<h4>{{ singular }}: <a href="{{ url }}">{{ title }}</a></h4>\n			<p>{{ description }}</p>\n		</article>\n\n	{{ /entries }}\n\n        {{ pagination }}\n\n{{ /search:results }}'),
(5, '2014-04-12 18:12:49', NULL, 1, NULL, '<p>We cannot find the page you are looking for, please click <a title="Home" href="{{ pages:url id=''1'' }}">here</a> to go to the homepage.</p>'),
(6, '2014-04-12 21:47:44', NULL, 1, 1, '{{ theme:partial name="demo" }}'),
(7, '2014-04-12 21:50:18', NULL, 1, 2, 'De handleiding...');
...
(4, 'Home', 0, 'page', 1, '', '', '', 1, 0, '', '0', ''),
(6, 'Plan X', 5, 'url', 0, '', 'http://google.nl', '', 1, 0, '', '0', ''),
(7, 'Bootstrap demo', 0, 'page', 6, '', '', '', 1, 4, '', '0', ''),
(8, 'Handleiding', 0, 'page', 7, '', '', '', 1, 3, '', '0', ''),
(9, 'Social Plan Module', 0, 'module', 0, 'socialplan', '', '', 1, 2, '', '2', '');
...
(1, 'home', '', 'Home', 'home', 0, '1', '1', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1397319169, 0, '', 1, 1, 0),
(2, 'contact', '', 'Contact', 'contact', 0, '1', '2', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1397319169, 0, '', 0, 1, 4),
(3, 'search', '', 'Search', 'search', 0, '1', '3', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1397319169, 0, '', 0, 1, 2),
(4, 'results', '', 'Results', 'search/results', 3, '1', '4', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1397319169, 0, '', 0, 0, 0),
(5, '404', '', 'Page missing', '404', 0, '1', '5', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1397319169, 0, '', 0, 1, 3),
(6, 'bootstrap-demo', '', 'Bootstrap demo', 'bootstrap-demo', 0, '1', '6', '', '', '', '', 0, 0, '', 0, 0, 'live', 1397324864, 0, '0', 0, 1, 5),
(7, 'handleiding', '', 'Handleiding', 'handleiding', 0, '1', '7', '', '', '', '', 0, 0, '', 0, 0, 'live', 1397325018, 0, '0', 0, 1, 1);
...
(1, 'default', 'Default', 'A simple page type with a WYSIWYG editor that will get you started adding content.', 2, '', NULL, '', '<div class="page-header">\n	<h1>{{ page:title }}</h1>\n</div>\n{{ body }}', '', '', 'default.html', 1397319575, 'n', '', '');
...
(1, NULL, NULL, NULL, NULL, 1, 'Elyse Teerink', 'Elyse', 'Teerink', '', 'en', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, '2014-04-12 21:21:06', NULL, NULL, 1, 2, 'menno.morsink', 'Menno', 'Morsink', NULL, 'en', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(6, 'Bootstrap demo', '', NULL, NULL, 'pages', 'pages:page', 'pages:pages', '6', 'bootstrap-demo', 'admin/pages/edit/6', 'admin/pages/delete/6'),
(7, 'Handleiding', '', NULL, NULL, 'pages', 'pages:page', 'pages:pages', '7', 'handleiding', 'admin/pages/edit/7', 'admin/pages/delete/7');
...
('contact_email', 'Contact E-mail', 'All e-mails from users, guests and the site will go to this e-mail address.', 'text', 'elyseteerink@gmail.com', '', '', 1, 1, 'email', 979),
...
('default_theme', 'Default Theme', 'Select the theme you want users to see by default.', '', 'default', 'mijnsocialplan', 'func:get_themes', 1, 0, '', 0),
...
('meta_topic', 'Meta Topic', 'Two or three words describing this type of company/website.', 'text', 'Content Management', 'site slogan', '', 0, 1, '', 998),
...
('site_lang', 'Site Language', 'The native language of the website, used to choose templates of e-mail notifications, contact form, and other features that should not depend on the language of a user.', 'select', 'en', 'nl', 'func:get_supported_lang', 1, 1, '', 997),
('site_name', 'Site Name', 'The name of the website for page titles and for use around the site.', 'text', 'Un-named Website', 'Mijn Social Plan', '', 1, 1, '', 1000),
('site_public_lang', 'Public Languages', 'Which are the languages really supported and offered on the front-end of your website?', 'checkbox', 'en', 'nl', 'func:get_supported_lang', 1, 1, '', 996),
('site_slogan', 'Site Slogan', 'The slogan of the website for page titles and for use around the site', 'text', '', 'site slogan', '', 0, 1, '', 999),
...
(11, 'theme', 'Theme Style', 'Choose a color style for your Bootstrap 3 theme (by <a href="http://bootswatch.com/">Bootswatch</a>)<br/> Documentation: <a href="http://www.vargapeter.com/blog/2013/12/boot3-theme-for-pyrocms.html">boot3 theme</a>', 'select', 'default', 'cerulean', 'custom=Custom (for developers)|default=Default (with shadows and gradients)|default_flat=Default (flat version)|amelia=Amelia|cerulean=Cerulean|cosmo=Cosmo|cyborg=Cyborg|flatly=Flatly|journal=Journal|readable=Readable|simplex=Simplex|slate=Slate|spacelab=Spacelab|united=United|yeti=Yeti', 1, 'boot3'),
(12, 'cdn', 'CDN', 'CDN support for Bootstrap''s CSS and JavaScript', 'select', '0', '1', '0=Local|1=CDN', 1, 'boot3'),
(13, 'js', 'Bootstrap JS mode', 'Use the compiled bootstrap js with all plugins or set to load plugins individualy. If you use CND, this option is not aviable. ', 'select', 'compiled', 'compiled', 'compiled=Compiled (load all plugins)|plugins=Load plugins individualy', 1, 'boot3'),
(14, 'js_plugins', 'Bootstrap JS plugins', 'Use only if you don'' use CDN and "Bootstrap JS mode" value is "Load plugins".', 'select-multiple', 'affix,alert,button,carousel,collapse,dropdown,modal,popover,scrollspy,tab,tooltip,transition', 'affix,alert,button,carousel,collapse,dropdown,modal,popover,scrollspy,tab,tooltip,transition', 'affix=affix|alert=alert|button=button|carousel=carousel|collapse=collapse|dropdown=dropdown|modal=modal|popover=popover|scrollspy=scrollspy|tab=tab|tooltip=tooltip|transition=transition', 1, 'boot3'),
(15, 'ie', 'IE Support', 'Bootstrap and icon IE support', 'select', '1', '1', '0=IE9+|1=IE7+', 1, 'boot3'),
(16, 'theme', 'Theme Style', 'Choose a color style for your Bootstrap 3 theme (by <a href="http://bootswatch.com/">Bootswatch</a>)<br/> Documentation: <a href="http://www.vargapeter.com/blog/2013/12/boot3-theme-for-pyrocms.html">boot3 theme</a>', 'select', 'default', 'cerulean', 'custom=Custom (for developers)|default=Default (with shadows and gradients)|default_flat=Default (flat version)|amelia=Amelia|cerulean=Cerulean|cosmo=Cosmo|cyborg=Cyborg|flatly=Flatly|journal=Journal|readable=Readable|simplex=Simplex|slate=Slate|spacelab=Spacelab|united=United|yeti=Yeti', 1, 'mijnsocialplan'),
(17, 'cdn', 'CDN', 'CDN support for Bootstrap''s CSS and JavaScript', 'select', '0', '1', '0=Local|1=CDN', 1, 'mijnsocialplan'),
(18, 'js', 'Bootstrap JS mode', 'Use the compiled bootstrap js with all plugins or set to load plugins individualy. If you use CND, this option is not aviable. ', 'select', 'compiled', 'compiled', 'compiled=Compiled (load all plugins)|plugins=Load plugins individualy', 1, 'mijnsocialplan'),
(19, 'js_plugins', 'Bootstrap JS plugins', 'Use only if you don'' use CDN and "Bootstrap JS mode" value is "Load plugins".', 'select-multiple', 'affix,alert,button,carousel,collapse,dropdown,modal,popover,scrollspy,tab,tooltip,transition', 'affix,alert,button,carousel,collapse,dropdown,modal,popover,scrollspy,tab,tooltip,transition', 'affix=affix|alert=alert|button=button|carousel=carousel|collapse=collapse|dropdown=dropdown|modal=modal|popover=popover|scrollspy=scrollspy|tab=tab|tooltip=tooltip|transition=transition', 1, 'mijnsocialplan'),
(20, 'ie', 'IE Support', 'Bootstrap and icon IE support', 'select', '1', '1', '0=IE9+|1=IE7+', 1, 'mijnsocialplan');
...
(1, 'elyseteerink@gmail.com', 'aa60dadcb759a8719602f94cd4ddb13512a561ad', '8f8ad', 1, '', 1, '', 1397319168, 1398271061, 'admin', NULL, '9e3a91ae7a482b4e22eca303019eef8c36553545'),
(2, 'mennomorsink@gmail.com', '5481568bb9ed4d7628554300589a4aaf39f8b424', '0e8892', 2, '::1', 1, '', 1397323266, 1397323266, 'menno.morsink', NULL, NULL);
