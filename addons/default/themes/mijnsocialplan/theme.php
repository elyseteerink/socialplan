...
class Theme_Mijnsocialplan extends Theme {

    public $name = 'Mijn Social Plan';
    public $author = 'Elyse Teerink';
    public $author_website = 'http://elyseteerink.nl';
    public $website = 'http://mijnsocialplan.nl';
    public $description = 'Mijn Social Plan thema';
